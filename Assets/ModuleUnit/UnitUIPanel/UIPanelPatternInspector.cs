...
/// 图案设计检查器
/// </summary>
public class UIPanelPatternInspector : UnitUIPanel {
    ...
    public void CreateUIPatternDesign() {
        ...
        datas.ForEach(CreateUIPatternDesign);
    }
    ...
    public class UIPatternDesign : UnitUIPanelItem<DataPatternDesign, UIPatternDesign> {
        public readonly UIPanelPatternInspector panel;
        ...
        public UIPatternDesign(DataPatternDesign value, VisualElement element, UIPanelPatternInspector panel) : base(value, element) {
            this.panel = panel;
    ...
    public class UIPatternDesignItem : UnitUIPanelItem<DataPatternDesignItem, UIPatternDesignItem> {
        public readonly UIPanelPatternInspector panel;
        public VisualElement BG => element.Q<VisualElement>("BG");
        public VisualElement Button => element.Q<VisualElement>("Button");
        public VisualElement Image => element.Q<VisualElement>("Image");
        ...
        public UIPatternDesignItem(DataPatternDesignItem value, VisualElement element, UIPanelPatternInspector panel) : base(value, element) {
            this.panel = panel;

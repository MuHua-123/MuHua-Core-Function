...
/// 素材库单元
/// </summary>
public class UIPanelPatternLibrary : UnitUIPanel {
    ...
    public void CreateUIPatternType() {
        ...
        List<DataPatternMaterials> datas = AssetsPatternMaterials.Datas;
        datas.ForEach(CreateUIPatternType);
    ...
    public class UIPatternType : UnitUIPanelItem<DataPatternMaterials, UIPatternType> {
        public readonly UIPanelPatternLibrary panel;
        public Button Type => element.Q<Button>();
        public UIPatternType(DataPatternMaterials value, VisualElement element, UIPanelPatternLibrary panel) : base(value, element) {
            this.panel = panel;
    ...
    public class UIPattern : UnitUIPanelItem<Texture2D, UIPattern> {
        public readonly UIPanelPatternLibrary panel;
        public VisualElement Image => element.Q<VisualElement>("Image");
        public UIPattern(Texture2D value, VisualElement element, UIPanelPatternLibrary panel) : base(value, element) {
            this.panel = panel;
